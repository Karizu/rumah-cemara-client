 ...
 */
public class ArticleTrainingFragment extends Fragment {
    ...
    public ArticleTrainingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.article_capacity_fragment, container, false);
    ...
    private void getListNews() {
        ...
        newsList.add(new News("1", "testing", "test", "June 20 2019", R.drawable.img_news));
        newsAdapter = new NewsAdapter(getActivity(), newsList, "highlight_article");
