package cemara.labschool.id.rumahcemara.home.highlight.broadcast;
...
import cemara.labschool.id.rumahcemara.home.highlight.broadcast.adapter.TabBroadcastAdapter;
...
public class BroadcastActivity extends AppCompatActivity {
    ...
    private void getCategory() {
        ...
        Loading.show(BroadcastActivity.this);
        BroadcastHelper.getBroadcastCategories(new RestCallback<ApiResponse<List<CategoryModel>>>() {
            @Override
            public void onSuccess(Headers headers, ApiResponse<List<CategoryModel>> body) {
                Loading.hide(BroadcastActivity.this);
                if (body.isStatus()) {
...
//                    }
                        ...
                        TabBroadcastAdapter tabAdapter = new TabBroadcastAdapter(getSupportFragmentManager(), BroadcastActivity.this, categoryList, id);
                        viewPager.setAdapter(tabAdapter);
                        tabLayout.setupWithViewPager(viewPager);
                    }else {
                        Toast.makeText(BroadcastActivity.this, "Category is empty", Toast.LENGTH_SHORT).show();
                    }
                } else {
//                        loadingDialog.dismiss();
                    Toast.makeText(BroadcastActivity.this, body.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailed(ErrorResponse error) {
                Loading.hide(BroadcastActivity.this);
                Toast.makeText(BroadcastActivity.this, "Gagal Ambil Data", Toast.LENGTH_SHORT).show();
            }
    ...
    public void setToolbar() {
        ...
        toolbarTitle.setText(getString(R.string.broadcast));
        toolbarImg.setImageResource(R.drawable.ic_record_voice_over_black_24dp);
