...
public class EventTrainingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.event_training_fragment, container, false);
    ...
    private void getListNews() {
        ...
        EventHelper.getEventTraining(new RestCallback<ApiResponse<List<Event>>>() {
            @Override
...
//            ivReminder.setOnClickListener(new MarkEventClickListener(coneventPager.get(position)));
