...
import cemara.labschool.id.rumahcemara.home.service.behavioral.FindServiceProvider.adapter.AdapterListProviderNearMe;
...
import cemara.labschool.id.rumahcemara.util.nearest.adapter.NearestProviderSearchAdapter;
...
//        getListNearest();
    ...
    private void setupAutocomplete() {
        ...
        EditText editTextAutocomplete = Objects.requireNonNull(autocompleteFragment.getView()).findViewById(R.id.place_autocomplete_search_input);
    ...
    private void populateData() {
        Loading.show(this);
        AppointmentHelper.getListProviderBehavioral(latitude, longitude, new RestCallback<ApiResponse<List<ProviderNearMeResponse>>>() {
            @Override
