...
import cemara.labschool.id.rumahcemara.home.service.structural.FindServiceProvider.adapter.AdapterListProviderNearMe;
...
//        longitude = 107.631200;
    ...
    private void populateData() {
        Loading.show(this);
        AppointmentHelper.getListProviderLegalCounseling(latitude, longitude, new RestCallback<ApiResponse<List<ProviderNearMeResponse>>>() {
            @Override
